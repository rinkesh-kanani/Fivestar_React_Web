    ...
    return (
      <div className='mr-auto float-left bookmark-wrapper d-flex align-items-center'>
        ...
        {/* <ul className='nav navbar-nav bookmark-icons'>
          ...
          <NavItem className='nav-item d-none d-lg-block' onClick={this.handleBookmarksVisibility}>
            <NavLink>
                    ...
                    return (
                      <li
                        ...
                        <Link
                          ...
                          onClick={() => this.setState({ showBookmarks: false })}>
                          <IconTag size={15} />
                          <span className='align-middle ml-1'>{suggestion.title}</span>
                        </Link>
                        <Icon.Star
