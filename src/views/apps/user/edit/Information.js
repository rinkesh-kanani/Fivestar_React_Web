...
const languages = [
  { value: "english", label: "English", color: "#33bdf2" },
  { value: "french", label: "French", color: "#33bdf2" },
  { value: "spanish", label: "Spanish", color: "#33bdf2" },
  { value: "russian", label: "Russian", color: "#33bdf2" },
  { value: "italian", label: "Italian", color: "#33bdf2" }
]

const colourStyles = {
  control: styles => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#33bdf2"
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#33bdf2")
      }
    }
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#33bdf2"
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#33bdf2",
      color: "white"
    }
  })
}
